...
public class CalculateAutoInsuranceImplUnitTest {
    ...
    void processScoreTest2(){
        Customer customer = Customer.builder().income(200001d).age(42).vehicle(new Vehicle(2005)).build();
        RiskScore riskScore = insurance.calculate(customer);
    ...
    void processScoreTest3(){
        Customer customer = Customer.builder().income(200000d).age(29).vehicle(new Vehicle(2005)).build();
        RiskScore riskScore = insurance.calculate(customer);
    ...
    void processScoreTest4(){
        Customer customer = Customer.builder().income(200000d).age(32).vehicle(new Vehicle(2005)).build();
        RiskScore riskScore = insurance.calculate(customer);
        assertThat(riskScore.getScore()).isEqualTo(-1);
        assertThat(riskScore.getProfile()).isEqualTo("economic");
    }
